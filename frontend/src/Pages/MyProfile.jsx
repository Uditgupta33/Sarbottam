    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <p className='font-medium'>Address:</p>
        {
          isEdit
          ? <p>
            <input className='bg-gray-50' value={userData.address.line1}  onChange={e => setUserData(prev => ({ 
          ...prev, 
          address: { 
            ...prev.address, 
            ...
            <br />
            <input className='bg-gray-50'  value={userData.address.line2} onChange={e => setUserData(prev => ({ 
          ...prev, 
          address: { 
            ...prev.address, 
